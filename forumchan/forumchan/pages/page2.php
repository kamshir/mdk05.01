		...
		<!-- main page -->
			...
			<div class="block__themes">
				...
				<section class="main__themes">
					...
					<div class="theme">
						<div class="text">
							<a href="#1" class='ser'><p class="zagol">GTA V</p></a>
						</div>
						<div class="recently">
							<div class="forums">
					...
					<div class="theme">
						<div class="text">
							<p class="zagol">Rick and Morty</p>
						</div>
						<div class="recently">
							<div class="forums">
				...
				<div class="pagination">
					<div class="puncts">
						...
						<div class="punct now"><a href="#2">2</a></div>
